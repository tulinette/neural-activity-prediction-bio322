...
## Acknowledgments
We would like to extend our sincere gratitude to the individuals and teams who made this project possible:
-   **Parviz Ghaderi** and the **Carl Petersen Lab at EPFL** for recording the invaluable and complex neural and behavioral data that formed the basis of this challenge.
-   **Tâm Nguyen** for meticulously preparing and providing the dataset for this miniproject.
-   The entire **BIO-322 teaching team** for their guidance, support, and for providing the opportunity to engage with such a challenging and rewarding real-world dataset.
